...
1. [Python Installation](https://github.com/ramonprz01/people-analytics/blob/master/setup/01_python_installation.md) - Here you will go through the step-by-step process of installing Python in your computer, make sure you pick the latest stable version for your Operating System when downloading Python.
